...
- [x] Type badges: color-coded categories (micro/brewpub/large etc.)
- [x] Could filter by state

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://github.com/user-attachments/assets/4fb94a61-3715-453e-94f8-f50bd49613fb' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
- I didn't really have any big challenges, just confliction on how to style it to my liking/theme on the database.
...
- [x] Hover description over data values
...
- Converting my currentPage state system with Real Routes using React Router
